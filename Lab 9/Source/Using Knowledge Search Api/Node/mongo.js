...
app.post('/getData', function (req, res) {
    ...
    MongoClient.connect(url, function(err, db) {
        ...
        //     res.end();
        // }
        // var docResponse = getDocument(db, req.body);
        // console.log("DOCRESPONSE are : "+ JSON.stringify(docResponse));
        //
        // if (docResponse.length > 0) {
        //     res.write(JSON.stringify(docResponse));
        // }
        // else {
...
// var getDocument = function(db, data) {
//     var cursor =db.collection('khushbutable').find( );
//     var results = [];
